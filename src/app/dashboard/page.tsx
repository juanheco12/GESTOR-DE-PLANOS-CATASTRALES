    ...
    return (
      <div className="p-6 lg:p-8 max-w-5xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <StatCard label="Total solicitudes" value={totalSolicitudes} icon={FileText} colorBg="bg-marca-50 dark:bg-marca-900/30" colorText="text-marca-700 dark:text-marca-400" href="/dashboard/solicitudes" />
        ...
        {misActivas.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/dashboard/solicitudes" className="text-sm text-marca-700 dark:text-marca-400 hover:underline">
                Ver todas
              </Link>
            </div>
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        ...
        {ingresadosHoy > 0 && (
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-marca-50 dark:bg-marca-900/30 text-marca-800 dark:text-marca-400 text-sm font-medium rounded-full border border-marca-200 dark:border-marca-800">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <StatCard label="Total en sistema" value={totalPlanos}         icon={FileText}       colorBg="bg-marca-50 dark:bg-marca-900/30"     colorText="text-marca-700 dark:text-marca-400"    href="/dashboard/buscar" />
        ...
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-base font-semibold text-slate-800 dark:text-slate-200">
            ...
            {actividadReciente.length > 0 && (
              <span className="ml-2 text-xs font-medium px-2 py-0.5 rounded-full bg-marca-100 dark:bg-marca-900/40 text-marca-800 dark:text-marca-300">
                {actividadReciente.length}
              </span>
            )}
          </h2>
          <Link href="/dashboard/historial" className="text-xs text-marca-700 dark:text-marca-400 hover:underline">
