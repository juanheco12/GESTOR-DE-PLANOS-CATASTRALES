      ...
      <form onSubmit={handleSubmit} className="space-y-5" autoComplete="off">
        ...
        <div>
          ...
          <input 
            ...
            className="w-full px-4 py-2.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-blue-500" 
          />
        </div>
