...
const ROLE_COLORS: Record<string, string> = {
  ADMINISTRADOR: "bg-marca-100 text-marca-800 dark:bg-marca-900/40 dark:text-marca-300",
      ...
      {isCreating && (
        ...
        >
          <h4 className="font-semibold text-slate-900 dark:text-slate-100 mb-4 flex items-center gap-2">
            <ShieldCheck className="h-4 w-4 text-marca-700" /> Registrar Nuevo Usuario
          </h4>
                    ...
                    <div className="flex flex-col gap-2 items-end">
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="text-sm font-medium text-marca-700 dark:text-marca-400 hover:underline inline-flex items-center gap-1"
                        >
                      ...
                      {changingPwdFor === user.id && (
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <button
                            ...
                            className="px-2 py-1 text-xs bg-marca-700 hover:bg-marca-800 text-white rounded disabled:opacity-50"
                          >
