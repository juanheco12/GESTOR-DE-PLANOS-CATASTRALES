                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <Link
                          ...
                          title="Ver detalle"
                          target="_blank"
                          className="p-1.5 rounded-lg text-slate-400 hover:text-marca-700 hover:bg-marca-50 dark:hover:text-marca-400 dark:hover:bg-marca-900/20 transition-colors"
                        >
