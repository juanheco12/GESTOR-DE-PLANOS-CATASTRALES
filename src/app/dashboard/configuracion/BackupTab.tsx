    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-700 p-6 flex flex-col sm:flex-row items-start sm:items-center gap-5">
        <div className="p-3 rounded-xl bg-blue-50 dark:bg-blue-900/30 shrink-0">
          <DatabaseBackup className="h-7 w-7 text-blue-600 dark:text-blue-400" />
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="shrink-0 inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium text-sm transition-colors disabled:opacity-60"
        >
